...
export const STARTUPS = [
  ...
  },
  {
    name: "Evervault",
    description:
      "Evervault mission is to make world-class data security effortless. Their vision is to encrypt the web.",
    founded: "2022",
    category: "SaaS",
  ...
  },
  {
    name: "Tines",
    description:
      "Tines helps teams build workflows tailored to the needs of their company, cleaning up tasks across a company's tech stack — any task with an API can be automated.",
    founded: "2018",
    category: "SaaS",
  ...
  {
    name: "CliniShift",
    description: "CliniShift is a healthcare technology company.",
    founded: "2016",
    category: "HealthTech",
